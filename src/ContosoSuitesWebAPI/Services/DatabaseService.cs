...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsForHotel(
        [Description("The hotel ID to search for bookings.")]
        int hotelId
        )
    {
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The hotel ID to search for bookings.")]
        int hotelId, 
        [Description("The minimum stay begin date for bookings.")]
        DateTime dt
        )
    {
    ...
    /// <summary>
    /// Get all bookings that don't have associted hotel rooms.
    /// </summary>
    [KernelFunction]
    ...
    /// <summary>
    /// Get all bookings that have multiple associated hotel rooms.
    /// </summary>
    [KernelFunction]
